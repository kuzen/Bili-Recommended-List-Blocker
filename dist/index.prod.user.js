...
// @author        kuzen <jldjz97@outlook.com>
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/less-loader/dist/cjs.js!./src/style/BiliBlocker.less":
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".brlb-block-btn .brlb-block-btn-icon,\n.brlb-block-btn-icon {\n  pointer-events: none;\n  user-select: none;\n  width: 22px;\n  height: 22px;\n  color: #fff;\n}\n.brlb-block-btn {\n  display: -webkit-flex;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  position: absolute;\n  top: 72px;\n  right: 8px;\n  width: 28px;\n  height: 28px;\n  border-radius: 6px;\n  cursor: pointer;\n  background-color: rgba(33, 33, 33, 0.8);\n  z-index: 9;\n  transform: translateZ(0);\n}\n.brlb-block-btn .brlb-block-btn-tip {\n  pointer-events: none;\n  user-select: none;\n  position: absolute;\n  bottom: -6px;\n  right: -10px;\n  transform: translateY(100%);\n  font-size: 12px;\n  color: #fff;\n  border-radius: 4px;\n  line-height: 18px;\n  padding: 4px 8px;\n  background-color: rgba(0, 0, 0, 0.8);\n  white-space: nowrap;\n}\n", ""]);
// Exports
...
class Setting {
  ...
  addSettingBtn() {
    ...
    }, [createElement('style', {}, [createElement('text', this.css.settingsPanel)]), createElement('style', {}, [createElement('text', this.css.bui)]), createElement('style', {}, [createElement('text', this.css.brlbBlockList)]), createElement('div', {
      style: {
        position: 'absolute',
        background: '#FFF',
        borderRadius: '10px',
    ...
    }, [createElement('h2', {}, [createElement('text', `${GM_info.script.name} v${GM_info.script.version} 设置`)]), createElement('br'), createElement('br'), createElement('form', {
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/less-loader/dist/cjs.js!./src/style/BiliBlocker.less
var BiliBlocker = __webpack_require__("./node_modules/css-loader/dist/cjs.js!./node_modules/less-loader/dist/cjs.js!./src/style/BiliBlocker.less");
;// CONCATENATED MODULE: ./src/style/BiliBlocker.less
...
class biliBlocker_BiliBlocker {
  constructor(blockList) {
    ...
    this.css = `.brlb-block-btn-icon {
                    background-image: url(${blockBtnIcon})
                }
                 .brlb-block .v-img.bili-video-card__cover {
...
;// CONCATENATED MODULE: ./src/blockList.js
class BlockList {
  constructor() {
    // 处理历史遗留问题（逃
    ...
    if (this.list != null) {
      ...
      Object.entries(this.list).forEach(_ref => {
        let [key, value] = _ref;
    ...
    Object.entries(this.list).forEach(_ref2 => {
      let [key, value] = _ref2;
...
async function main() {
  window.addEventListener('DOMContentLoaded', () => {
    ...
    const biliBlocker = new biliBlocker_BiliBlocker(blockList);
